...
if __name__ == '__main__':
    ...
    batch_size = 150
# =============================================================================
#     train_session = ['Session13','Session06','Session07','Session12']
#    
#     X_train=[]
#     y_train=[]
#     print('Training')
...
# =============================================================================
    ...
    X_train = pd.read_csv('Train_Features/train_features.csv', header=None)
    y_train = pd.read_csv('Train_Features/train_labels.csv', header=None)
...
# #    y_pred,cm = predict(classifier, X_test)
#     
# # =============================================================================
...
#     X_test={}
#     y_pred={}
#     test_session = ['Session01','Session05']
...
#         df = pd.DataFrame(y_pred[i],dtype = np.float64)
#         df.to_csv('Training Data/'+i+'/prediction.txt', index=False, header=False)   
#         
#     
...
#         y_pred[i] = np.append([0]*batch_size,y_pred[i])
#         df = pd.DataFrame(y_pred[i],dtype = np.float64)
#         df.to_csv('Test Data 1/'+i+'/prediction.txt', index=False, header=False)   
# =============================================================================
